...
# =========================
ALLOWED_CHANNEL_ID = 987654321098765432  # ضع ID الروم الخاص بالبوت الثاني هنا
...
async def top(ctx):
    ...
    embed = discord.Embed(title="🏆 Top Points", description=description, color=discord.Color.gold())
    await ctx.send(embed=embed)
